-- Add unique constraint for characters table to support ON CONFLICT
ALTER TABLE characters ADD CONSTRAINT characters_video_id_name_key UNIQUE (video_id, name);
