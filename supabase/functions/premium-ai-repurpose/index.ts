...
serve(async (req) => {
  ...
  try {
    ...
    console.log('[premium-ai-repurpose] Request received:', { projectId, options });
    ...
    console.log('[premium-ai-repurpose] Job created successfully:', job.id);

    // TODO: Implement video repurposing logic
