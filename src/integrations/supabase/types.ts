  ...
  public: {
    Tables: {
        ...
        Relationships: [
          {
            ...
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "premium_projects"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "ai_suggestions_video_id_fkey"
            columns: ["video_id"]
            isOneToOne: false
      ...
      feature_usage: {
        ...
        Relationships: [
          {
            foreignKeyName: "feature_usage_video_id_fkey"
            columns: ["video_id"]
            isOneToOne: false
            referencedRelation: "videos"
            referencedColumns: ["id"]
      ...
      generated_metadata: {
        ...
        Relationships: [
          {
            foreignKeyName: "generated_metadata_video_id_fkey"
            columns: ["video_id"]
            isOneToOne: false
            referencedRelation: "videos"
            referencedColumns: ["id"]
      ...
      premium_projects: {
        Row: {
          ...
          default_transition_duration_ms: number | null
          description: string | null
          id: string
      ...
      project_comments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "project_comments_scene_id_fkey"
            columns: ["scene_id"]
            isOneToOne: false
      ...
      published_videos: {
        ...
        Relationships: [
          {
            foreignKeyName: "published_videos_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "premium_projects"
            referencedColumns: ["id"]
      ...
      scene_layers: {
        ...
        Relationships: [
          {
            foreignKeyName: "scene_layers_scene_id_fkey"
            columns: ["scene_id"]
            isOneToOne: false
            referencedRelation: "project_scenes"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      reorder_scenes: {
        Args: { p_project_id: string; p_scene_orders: Json }
        Returns: undefined
      }
      reset_monthly_usage: {
        Args: never
